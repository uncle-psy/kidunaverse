import { coherenceDimensions, fieldObjects, historyEntries, layoutTypes, packages, receiverThemes, receiverV2Catalog, receiverV2ReceivedAt, transmitterCatalog } from './data.js?v=0.5.0';
